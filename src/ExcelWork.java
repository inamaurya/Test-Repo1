...
public class ExcelWork {
    public static void main(String[] args) {
        ...
        try {
            ...
            rootElement.appendChild(createUserElement(doc, ""+i, "Ramesh", "Fadatare", "28", "Male"));
            i=i+9;
            }
/*
            // append second child
...
//            StreamResult console = new StreamResult(System.out);
            StreamResult file = new StreamResult(new File("C:\\Users\\I536070\\Downloads\\TestExcel\\create_users.xml"));
